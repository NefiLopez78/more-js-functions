...
function addTheValues(param1, param2){
    if(isNaN(param1) || isNaN(param2)){
        ...
        addToPage("Both values are numbers. Added togther they equal: " + (parseInt(param1) + " " + parseInt(param2)))
    }
}
...
function scopeExample(){
    let localVariable = "This is a local variable inside of the scoreExample function.";
